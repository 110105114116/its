							...
							<div class="flex flex-col gap-6">
								<!-- <div class="card">
									<div class="card-body">
										...
										<div class="flex items-center justify-between gap-12">
											<div>
												<h3 class="text-[40px] font-semibold text-gray-500 mb-4"><?php echo $data->count; ?></h3>
									...
									<div class="card-body">
										<div class="flex gap-6 items-center justify-between">
											<div class="flex flex-col gap-4">
												<h4 class="text-gray-500 text-lg font-semibold">Equipment</h4>
												<div class="flex flex-col gap-4">
													<h3 class="text-[40px] font-semibold text-gray-500"><?php echo $data->count; ?></h3>
								...
								<div class="card">
									<div class="card-body">
										<div class="flex gap-6 items-center justify-between">
											<div class="flex flex-col gap-4">
												<h4 class="text-gray-500 text-lg font-semibold">Active</h4>
												<div class="flex flex-col gap-4">
													<h3 class="text-[40px] font-semibold text-gray-500"><?php echo $data->active; ?></h3>
													<div class="flex items-center gap-1">
														<span class="flex items-center justify-center w-5 h-5 rounded-full bg-green-400">
															<i class="ti ti-refresh text-green-500"></i>
														</span>
								...
								<div class="card">
									<div class="card-body">
										<div class="flex gap-6 items-center justify-between">
											<div class="flex flex-col gap-4">
												<h4 class="text-gray-500 text-lg font-semibold">In-Active</h4>
												<div class="flex flex-col gap-4">
													<h3 class="text-[40px] font-semibold text-gray-500"><?php echo $data->inactive; ?></h3>
													<div class="flex items-center gap-1">
														<span class="flex items-center justify-center w-5 h-5 rounded-full bg-green-400">
															<i class="ti ti-refresh text-green-500"></i>
														</span>
