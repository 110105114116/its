            ...
            <div class="flex-1 w-5/6 h-max p-4">
                <nav class="" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
						...
						<li class="inline-flex items-center">
                            <a href="<?php echo BASE_URL(); ?>vehicle" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                        ...
                        <li aria-current="page">
							<div class="flex items-center">
								...
								<span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Add new vehicle</span>
							</div>
                        </li>
                    </ol>
                </nav>

				<form class="w-3/5 mx-auto mt-3 p-8" action="<?php echo BASE_URL(); ?>vehicle/addVehicle" method="get">
					<div class="text-center text-2xl mb-8">New vehicle</div>
					...
					<div class="grid md:grid-cols-2 md:gap-6">
						...
						<div class="relative z-0 w-full mb-5 group">
							...
							<label 
								...
								peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 
								peer-focus:scale-75 peer-focus:-translate-y-6"
							>License plate no.</label>
						</div>
					</div>

					<div class="grid md:grid-cols-2 md:gap-6">
						<div class="relative z-0 w-full mb-5 group">
							<label for="licenseType" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Type</label>
							<select 
								name="licenseType" 
								id="licenseType" 
